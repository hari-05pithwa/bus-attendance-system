        ...
        <form className="space-y-5" onSubmit={handleSubmit} noValidate>
          <div className="space-y-4">
            ...
            <div className="group space-y-1">
              ...
              <div className="relative flex items-center">
                <Bus size={20} className="absolute left-4 text-slate-400 z-10" />
                <select
                  value={busId}
                  onChange={(e) => setBusId(e.target.value)}
            ...
            <div className="group space-y-1">
              <label className="text-[10px] font-black text-indigo-600 uppercase tracking-widest ml-1">Vehicle Number</label>
              <div className="relative flex items-center">
                <Lock size={20} className="absolute left-4 text-slate-400 group-focus-within:text-indigo-600" />
                <input
                  type={showPassword ? "text" : "password"}
